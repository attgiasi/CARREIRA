...
- Coquetelaria clássica e autoral, mixologia e preparo de insumos.
- Atendimento premium, hospitalidade, guest experience e recuperação de serviço.
- Abertura e fechamento de bar, mise en place e organização de praça.
- Padronização de receitas, fichas técnicas, apresentação e controle de qualidade.
- Controle de estoque, inventário, reposição, validade e redução de perdas.
- Liderança operacional, treinamento, integração e orientação de equipes.
...
- Preparo de bebidas, coquetéis e insumos conforme receitas e padrão da operação.
...
- Atendimento ao cliente, escuta ativa, registro de informações e resolução de solicitações.
- Comunicação clara e controle emocional em situações de alta exigência.
- Trabalho com procedimentos, sistemas internos, metas e padronização de comunicação.
- Reconhecimento por qualidade de serviço e desempenho operacional.

### Ponto Jazz Gastrobar | Head Bartender

**Curitiba/PR | 07/2023 a 12/2023**

- Liderança da rotina de bar, organização da equipe e manutenção do padrão de serviço.
...
- Padronização de receitas, preparo de coquetéis e controle de apresentação.
- Organização de insumos, estoque e fluxo de atendimento integrado ao salão.

### Siberiano Bar | Head Bartender

**Curitiba/PR | 08/2016 a 09/2018**

- Coordenação da rotina de bar e orientação da equipe durante o serviço.
- Coquetelaria, produção de insumos, organização de praça e controle operacional.
- Atendimento próximo ao cliente e manutenção de qualidade em períodos de alto fluxo.

### Lucci Meeting Club | Gerente

**Curitiba/PR | 08/2014 a 11/2015**
...
- Controle de prioridades, integração entre áreas e manutenção do padrão de serviço.

## Formação

- Administração de Empresas | Unicastelo | 2010 a 2013.
- Gestão de Eventos e Cerimonial Público e Privado | UEPG | 2017 a 2018.

## Posicionamento para candidaturas

Priorizar vagas de bartender, barman, bartender sênior, head bartender, chefe ou supervisor de bar, bar manager, consultoria de bares, gestão de alimentos e bebidas, treinamento e experiência do cliente em hotéis, resorts, restaurantes, bares e eventos de alto padrão.

Valorizar a experiência real em coquetelaria, hospitalidade, liderança, padronização, treinamento, organização e atendimento premium. Não inventar idiomas, certificações, resultados numéricos, CNH ou cursos que não estejam confirmados no perfil.
